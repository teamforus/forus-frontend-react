    ...
    return (
        <Section type={'faq'}>
            ...
            {faqGroups.map((group, index) => (
                <div className="block block-faq" key={index}>
                    {group.heading && (
                        <div className="block-faq-header">
                            <div className="block-faq-title">{group.heading.title}</div>
                            <div className="block-faq-subtitle">{group.heading.subtitle}</div>
                        </div>
                    )}
