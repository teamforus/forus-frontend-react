            ...
            return {
                ...
                records: criteria.map((criterion) => {
                    ...
                    return fund?.auto_validation
                        ? { files: [], value: makeValue ? makeValue() : null, fund_criterion_id: id, record_type_key: record_type_key }
                        : { files: files_uid, value: input_value, fund_criterion_id: id, record_type_key: record_type_key };
                }),
            };
        },
