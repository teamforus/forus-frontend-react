export default {
    ...
    map: {
        title: 'Bekijk onze kaart',
        subtitle: 'Vind locaties en voorzieningen bij u in de buurt.',
        show: 'Toon kaart',
    },
    faq: {
    ...
    nijmegen: {
        ...
        description:
            'De gemeente Nijmegen heeft verschillende vergoedingen voor mensen met een laag inkomen. Denk aan de Meedoenregeling, dan krijgen inwoners met een laag inkomen maximaal € 150,- voor culturele, sportieve en educatieve activiteiten. Of bijvoorbeeld het busvoordeelabonnement. Alle vergoedingen vindt u hieronder.',
        participation_scheme: 'Meedoenregeling',
        bus_benefit_subscription: 'Busvoordeelabonnement',
        individual_income_allowance: 'Individuele inkomenstoeslag',
        study_allowance: 'Studietoeslag',
        collective_health_insurance: 'Collectieve Aanvullende Ziektekostenverzekering (CAZ)',
        special_assistance: 'Bijzondere bijstand',
        tax_relief: 'Kwijtschelding gemeentelijke belastingen',
        more_info: 'Meer vergoedingen van gemeente Nijmegen',
    },
    leergeld: {
        title: 'Stichting Leergeld Nijmegen',
        description:
            'Leergeld Nijmegen heeft als doel alle Nijmeegse kinderen mee te laten doen. Voor kinderen uit gezinnen met een laag inkomen kan dit een probleem zijn. Leergeld Nijmegen biedt de mogelijkheid aan deze kinderen in de leeftijd van 0 tot en met 17 jaar om te kunnen deelnemen aan allerlei activiteiten.',
        help_for_child: 'Hulp voor uw kind',
        more_info: 'Meer informatie over Stichting Leergeld Nijmegen',
    },
    pre_check: {
        take_check: 'Doe de check',
    },
};
