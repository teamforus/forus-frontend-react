                        ...
                        <div className="col col-lg-12 col-xs-12">
                            ...
                            <InfoBox>
                                <p>
                                    ...
                                    logisch te groeperen. Dit helpt om de Regelingencheck overzichtelijker, zodat niet 
                                    alle vragen in één lange lijst worden getoond. Voorwaarden kunnen eenvoudig worden 
                                    verplaatst naar een andere stap door erop te klikken en deze naar de gewenste 
                                    stap te slepen.
                                </p>
                            </InfoBox>
                        </div>
