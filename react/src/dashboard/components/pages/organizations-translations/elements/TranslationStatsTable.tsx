...
export default function TranslationStatsTable({
    ...
    const { headElement, configsElement } = useConfigurableTable(organizationService.getTranslationStatsColumns());
                                    ...
                                    {index === stats.data.groups?.length - 1 && (
                                        <tr className={'tr-totals'}>
                                            ...
                                            <td className={'text-strong'}>
                                                {numberFormat(stats?.data?.total?.symbols || 0)}
                                            </td>
