...
export default function ImplementationPageCreate() {
        ...
        implementationService
            ...
            .then((res) => {
                if (res.data.data.pages.find((page) => page.page_type === type)) {
                    return navigateState('implementation-view', {
                        id: res.data.data.id,
    ...
    return <ImplementationsPageForm implementation={implementation} pageType={type} />;
}
