    ...
    return (
        <form className="card form" onSubmit={form.submit}>
            <div className="card-header" onClick={() => setCollapsed(!collapsed)}>
                <div className="card-title">Instellingen aanvraagformulier</div>
            </div>
            ...
            <div className="card-body">
                <div className="card-section">
                        ...
                        <div className="col col-xs-12 col-lg-6">
                            <div className="form-group">
                                ...
                                <FormGroupInfo
                                    info={
                                        <p>
                                            Banner tekst Een korte tekst onder het aanvraagformulier over de hulp optie
                                            tijdens het invullen van het aanvraagformulier. Deze tekst wordt naast de
                                            hulp knop getoond.
                                        </p>
                                    }>
                                    <input
                        ...
                        <div className="col col-xs-12 col-lg-6">
                            <div className="form-group">
                                ...
                                <FormGroupInfo
                                    info={
                                        <p>
                                            Knop tekst De tekst van de knop onder het aanvraagformulier. Door te klikken
                                            op deze knop opent er meer informatie (en contactinformatie) over de geboden
                                            ondersteuning.
                                        </p>
                                    }>
                                    <input
                    ...
                    <div className="form-group">
                        <label className="form-label">{translate('fund_request_configurations.labels.title')}</label>
                        ...
                        <div className="col col-xs-12 col-lg-6">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    placeholder={translate('fund_request_configurations.labels.website_placeholder')}
