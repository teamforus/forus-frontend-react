                    ...
                    <div className="row">
                        <div className="col col-md-8 col-md-offset-2 col-xs-12">
                            {form.values.contacts?.map((contact, index) => (
                                <div key={contact.key} className="form-group">
                                                ...
                                                <div className="info-box-content">
                                                    <div className="block block-markdown">
                                                        ...
                                                        <p>
                                                            ...
                                                            wanneer het saldo op het fonds te laag is. Dit kan ook een
                                                            e-mailadres zijn dat geen medewerker is van de organisatie.
                                                        </p>
                                                    </div>
                                                </div>
                                            )}
                                            ...
                                            {contact.key == 'bank_connections_expiring' && (
                                                <div className="info-box-content">
                                                    <div className="block block-markdown">
                                                        ...
                                                        <p>
                                                            Vul hier een e-mailadres in dat een notificatie krijgt
                                                            wanneer de huidige bank integratie verloopt. Dit kan ook een
                                                            e-mailadres zijn dat geen medewerker is van de organisatie.
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            {contact.key == 'provider_applied' && (
                                                <div className="info-box-content">
                                                    <div className="block block-markdown">
                                                        ...
                                                        <p>
                                                            Vul hier een e-mailadres in dat een notificatie krijgt
                                                            wanneer een aanbieder zich heeft aangemeld voor een fonds.
                                                            Dit kan ook een e-mailadres zijn dat geen medewerker is van
                                                            de organisatie.
                                                        </p>
                                                    </div>
                                                </div>
