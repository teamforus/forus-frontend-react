...
export default function ModalReservationInvoiceNumberEdit({
    ...
    return (
        <div
            ...
            data-dusk="modalReservationInvoiceNumberEdit">
            <div className="modal-backdrop" onClick={modal.close} />
            <div className="modal-window">
                <div className="modal-close mdi mdi-close" onClick={modal.close} />
                <div className="modal-header">{translate('modals.modal_invoice_number_edit.title')}</div>
                <div className="modal-body form">
                    <div className="modal-section">
                        <FormGroup
                            ...
                            info={
                                <Fragment>
                                    Het factuurnummer dat u invult kunt u gebruiken ter registratie. Let hierbij op dat
                                    het factuurnummer aan het bankafschrift wordt toegevoegd wanneer de reservering is
                                    uitbetaald. U kunt dit aan- of uitzetten bij de transactie instellingen.
                                </Fragment>
                            }
                            input={(id) => (
                                <input
