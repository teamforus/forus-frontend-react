...
export enum DashboardRoutes {
    ...
    IMPLEMENTATION_CMS = 'implementations-cms',
    IMPLEMENTATION_CMS_PAGE_EDIT = 'implementations-cms-page-edit',
    IMPLEMENTATION_CMS_PAGE_CREATE = 'implementations-cms-page-create',
